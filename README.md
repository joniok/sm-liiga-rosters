...
The site is automatically built and deployed to GitHub Pages **three times per day** (about 07:00, 13:30, and 23:00 Finnish time in winter / EET; see workflow comments for UTC) via GitHub Actions. You can also trigger a build manually from the Actions tab.
